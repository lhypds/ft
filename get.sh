...
#
# Downloads a release zip from GitHub, unpacks it into ~/.ft, then runs the
# shipped setup.sh and install.sh — which build the venv, install the Python
# dependencies, and write the ~/.local/bin/ft launcher.
#
# Options (flag or environment variable):
#   --version 0.0.2   FT_VERSION=0.0.2   install a specific release (default: latest)
#   --dir PATH        FT_HOME=PATH       where to unpack (default: ~/.ft)
#   --help
#
